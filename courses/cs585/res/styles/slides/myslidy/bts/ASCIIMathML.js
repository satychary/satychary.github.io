...
var mathfontsize = "1.0em";      // change to e.g. 1.2em for larger math
...
function AMnoMathMLNote() {
  var nd = AMcreateElementXHTML("h4");
  nd.setAttribute("align","left")
  nd.appendChild(AMcreateElementXHTML("p"));
  nd.appendChild(document.createTextNode("Note: to view the math notation in this page marked up using "));
  var an = AMcreateElementXHTML("a");
  an.appendChild(document.createTextNode("ASCIIMathML"));
  an.setAttribute("href","http://www.chapman.edu/~jipsen/asciimath.html");
  nd.appendChild(an);
  nd.appendChild(document.createTextNode(", view the page in Internet Explorer + "));  
  an = AMcreateElementXHTML("a");
  an.appendChild(document.createTextNode("MathPlayer"));
  an.setAttribute("href","http://www.dessci.com/en/products/mathplayer/download.htm");
  nd.appendChild(an);
  nd.appendChild(document.createTextNode(", or in Mozilla/Firefox."));
  nd.appendChild(AMcreateElementXHTML("p"));
  return nd;
}
