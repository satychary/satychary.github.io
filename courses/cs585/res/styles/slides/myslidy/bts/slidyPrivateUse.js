...
var viewAll = 0;    // was 0-saty  // 1 to view all slides + handouts
var wantToolbar = 1;   // 0 if toolbar isn't wanted // was 0 - saty
var mouseClickEnabled = true; // was false;  // enables left click for next slide
