! function(e, t, n) {
        ...
        ! function() {
            var hljs = new function() {
                    ...
                    function highlightBlock(block) {
                        var text = options.useBR ? block.innerHTML.replace(/\n/g, "").replace(/<br>|<br [^>]*>/g, "\n").replace(/<[^>]*>/g, "") : block.textContent;
                ...
                languages = [{
                    ...
                    create: function(hljs) {
                        ...
                        var RUBY_DEFAULT_CONTAINS = [STRING, COMMENT, {
                            className: "class",
                    ...
                    create: function(hljs) {
                        ...
                        return {
                            ...
                            contains: [{
                                ...
                                beginKeywords: "protected public private",
                                end: /[{;=]/,
                                keywords: KEYWORDS,
                                contains: [{
                                    className: "class",
                    ...
                    create: function(hljs) {
                        ...
                        return {
                            ...
                            contains: [{
                                ...
                                beginKeywords: "protected public private internal",
                                end: /[{;=]/,
                                keywords: KEYWORDS,
                                contains: [{
                    ...
                    create: function(hljs) {
                        ...
                        return {
                            ...
                            contains: [{
                                ...
                                relevance: 10
                            }, hljs.C_LINE_COMMENT_MODE, hljs.C_BLOCK_COMMENT_MODE, STRING, hljs.QUOTE_STRING_MODE, SYMBOL, {
                                className: "class",
                                ...
                                contains: [{
                                    ...
                                    contains: [hljs.QUOTE_STRING_MODE, STRING, ANNOTATION]
                                }]
                            }, hljs.C_NUMBER_MODE, ANNOTATION]
                        }
                    }
                }, {
                    name: "coffeescript",
                    ...
                    create: function(hljs) {
                        ...
                        return {
                            illegal: /\S/,
                            contains: [NUMBER, SHEBANG, LITERAL, STRING, COMMENT, QUOTED, LIST]
                        }
                    }
                }, {
                    name: "clojure",
                    ...
                    create: function(hljs) {
                        ...
                        return {
                            ...
                            }, PRAGMA, COMMENT, PREPROCESSOR, hljs.QUOTE_STRING_MODE, hljs.C_NUMBER_MODE, CONSTRUCTOR, hljs.inherit(hljs.TITLE_MODE, {
                                begin: "^[_a-z][\\w']*"
                            }), {
                                begin: "->|<-"
                            }]
    ...
    9: [function(require, module, exports) {
        ...
        function handleFullscreen(self) {
            ...
            self.events.on("toggleFullscreen", function() {
                var fullscreenElement = utils.getPrefixedProperty(document, "fullscreenElement") || utils.getPrefixedProperty(document, "fullScreenElement");
        ...
        SlideshowView.prototype.configureContainerElement = function(element) {
            ...
            if (element === self.dom.getBodyElement()) {
                ...
                forwardEvents(self.events, window, ["hashchange", "resize", "keydown", "keypress", "mousewheel", "message"]);
                forwardEvents(self.events, self.containerElement, ["touchstart", "touchmove", "touchend", "click", "contextmenu"])
            } else {
                element.style.position = "absolute";
                element.tabIndex = -1;
                forwardEvents(self.events, window, ["resize"]);
                forwardEvents(self.events, element, ["keydown", "keypress", "mousewheel", "touchstart", "touchmove", "touchend"])
            }
        ...
        SlideshowView.prototype.configureChildElements = function() {
            ...
            var commands = {
                increase: function() {
                    self.notesElement.style.fontSize = (parseFloat(self.notesElement.style.fontSize) || 1) + .1 + "em"
                },
                decrease: function() {
                    self.notesElement.style.fontSize = (parseFloat(self.notesElement.style.fontSize) || 1) - .1 + "em"
                }
        ...
        SlideshowView.prototype.updateTimer = function() {
            ...
            if (self.startTime) {
                ...
                var seconds = Math.floor(millis / 1e3) % 60;
                var minutes = Math.floor(millis / 6e4) % 60;
    ...
    14: [function(require, module, exports) {
        ...
        exports.removeClass = function(element, className) {
            element.className = exports.getClasses(element).filter(function(klass) {
        ...
        exports.getClasses = function(element) {
            return element.className.split(" ").filter(function(s) {
                return s !== ""
            })
        };
        ...
        exports.getPrefixedProperty = function(element, propertyName) {
            var capitalizedPropertName = propertyName[0].toUpperCase() + propertyName.slice(1);
            return element[propertyName] || element["moz" + capitalizedPropertName] || element["webkit" + capitalizedPropertName]
        }
    }, {}],
    15: [function(require, module, exports) {
        ...
        function inheritProperties(slide, template) {
            ...
            for (property in template.properties) {
                if (!template.properties.hasOwnProperty(property) || ignoreProperty(property)) {
                    continue
                }
        ...
        function ignoreProperty(property) {
            return property === "name" || property === "layout"
        }
    ...
    18: [function(require, module, exports) {
        ...
        Scaler.prototype.scaleToFit = function(element, container) {
            var self = this,
                ...
                scale, scaledWidth, scaledHeight, ratio = self.ratio,
    ...
    16: [function(require, module, exports) {
        ! function() {
            ...
            function cleanInput(source) {
                ...
                var whitespace = getMatchCaptures(source, leadingWhitespacePattern).map(function(s) {
                    return s.length
                });
    ...
    17: [function(require, module, exports) {
        ...
        function setHighlightStyleFromProperties(element, properties, slideshow) {
            var highlightStyle = properties["highlight-style"] || slideshow.getHighlightStyle();
            if (highlightStyle) {
        ...
        function setClassFromProperties(element, properties) {
            ...
            (properties["class"] || "").split(/,| /).filter(function(s) {
                return s !== ""
            }).forEach(function(c) {
