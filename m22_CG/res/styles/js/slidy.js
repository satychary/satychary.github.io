...
strings_es[helpText] =
    ...
    "o Re p?g y Av p?g. Use S y B para cambiar el tama?o de fuente.";
...
strings_ca[helpText] =
   ...
   "o Re p?g y Av p?g. Usi S i B per canviar grand?ria de font.";
...
var strings_de = {
  ...
  "Table of Contents":"Inhaltsverzeichnis",
  "restart presentation":"Pr?sentation neu starten",
  "restart?":"Neustart"
   };

strings_de[helpText] =
    "Benutzen Sie die Maus, Leerschlag, die Cursortasten links/rechts oder " +
    "Page up/Page Down zum Wechseln der Seiten und S und B f?r die Schriftgr?sse.";
...
strings_fr[helpText] =
    "Naviguez avec la souris, la barre d'espace, les fl?ches " +
...
var strings_hu = {
  ...
  "Table of Contents":"Tartalomjegyz?k",
  "restart presentation":"bemutat? ?jraind?t?sa",
  "restart?":"?jraind?t?s"
   };

strings_hu[helpText] =
    "Az oldalak k?zti l?pked?shez kattintson az eg?rrel, vagy " +
    "haszn?lja a sz?k?z, a bal, vagy a jobb ny?l, illetve a Page Down, " +
    "Page Up billenty?ket. Az S ?s a B billenty?kkel v?ltoztathatja " +
    "a sz?veg m?ret?t.";
